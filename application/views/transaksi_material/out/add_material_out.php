...
<div class="container-fluid">
  ...
  <!-- <div class="row"> -->
    ...
    <form class="" action="<?= base_url('transaksi_material/proses_add_material_out'); ?>" method="post">
      <div class="form-group row">
        <label for="inputMat_doc" class="col-sm-2 col-form-label">Mat_doc</label>
        <div class="col-sm-10">
          <input type="text" class="form-control" id="inputMat_doc" readonly="readonly" name="mat_doc" placeholder="Generated By System">
        </div>
      </div>
      <div class="form-group row">
